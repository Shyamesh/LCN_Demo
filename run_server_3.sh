...
PID2=$!
iperf3 -s -p 5203 > iperf_5202.log 2>&1 &
PID3=$!

# Start a single tcpdump for both ports
tcpdump -i any 'port 5201 or port 5202 or port 5203' -w combined_capture.pcapng &
TCPDUMP=$!

# Ensure cleanup on exit
trap "kill $TCPDUMP $PID1 $PID2 $PID3 2>/dev/null; echo 'Processes terminated'; exit" EXIT
