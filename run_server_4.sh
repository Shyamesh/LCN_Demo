...
PID1=$!
iperf3 -s -p 5202 > "$OUTPUT_DIR/iperf_5202.log" 2>&1 &
PID2=$!
iperf3 -s -p 5203 > "$OUTPUT_DIR/iperf_5203.log" 2>&1 &
PID3=$!
iperf3 -s -p 5204 > "$OUTPUT_DIR/iperf_5204.log" 2>&1 &
PID4=$!

# Start tcpdump for all 4 ports
echo "Starting tcpdump..."
tcpdump -i any 'port 5201 or port 5202 or port 5203 or port 5204' -w "$OUTPUT_DIR/combined_capture.pcapng" &
TCPDUMP=$!

# Ensure cleanup on exit
trap "kill $TCPDUMP $PID1 $PID2 $PID3 $PID4 2>/dev/null; echo 'Processes terminated'; exit" EXIT
